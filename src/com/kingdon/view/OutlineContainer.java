...
import com.kingdon.util.CommonUtils;
...
public class OutlineContainer extends FrameLayout implements Animatable {
	...
	private void init() {
		...
		mOutlinePaint.setStrokeWidth(CommonUtils.dpToPx(getResources(), 2));
		mOutlinePaint.setColor(getResources().getColor(R.color.gray));
		mOutlinePaint.setStyle(Style.STROKE);

		int padding = CommonUtils.dpToPx(getResources(), 10);
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		int offset = CommonUtils.dpToPx(getResources(), 5);
