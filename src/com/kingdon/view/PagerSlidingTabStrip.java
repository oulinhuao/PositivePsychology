...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int selectedTabBGColor = 0xFF666666;
	...
	private void setMargin(){
		defaultTabLayoutParams.setMargins(0, 0, 0, indicatorHeight);
	...
	public void setSelectedBGColorResource(int resId) {
		this.selectedTabBGColor = resId;
		updateTabStyles();
	}
